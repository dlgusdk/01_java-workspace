...
public class ExMenu {
	...
	public void selectProduct() {
		...
		// ec의 selectProduct메소드 호출하여 ArrayList 돌려받기
		 ArrayList<Product> productList = ec.selectProduct();
	...
	public void insertProduct() {
		...
		System.out.print("추가하고자하는 제품명을 입력하세요 : ");
		String name = sc.nextLine();
		
		
		// 추가하고자 하는 제품의 브랜드명 입력받기 (String brand 변수에 기록)
		System.out.print("추가하고자하는 제품의 브랜드명을 입력하세요 : ");
		String brand = sc.nextLine();
		
		
		// 추가하고자 하는 제품의 가격 입력받기 (String price 변수에 기록) 
		System.out.print("추가하고자하는 제품의 가격을 입력하세요 : ");
	...
	public void deleteProduct() {
		...
		System.out.print("삭제하고자하는 제품의 제품명을 입력하세요 : ");
		String name = sc.nextLine();
		
		
		// 삭제하고자 하는 제품의 브랜드명 입력받기 (String brand 변수에 기록)
		System.out.print("삭제하고자하는 브랜드명을 입력하세요 : ");
		String brand = sc.nextLine();
	...
	public void selectPrice() {
		...
		System.out.print("가격 검색하고자하는 제품명을 입력하세요 : ");
		String name = sc.nextLine();
		
		// 가격 검색하고자 하는 제품의 브랜드명 입력받기 (String brand 변수에 기록)
		System.out.print("가격 검색하고자하는 제품의 브랜드명을 입력하세요 : ");
		String brand = sc.nextLine();
		
		// ec의 selectPrice메소드 호출시 위의 입력값 전달하면서 호출하고 이때 돌아오는 가격값 받기
		int rePrice = ec.selectPrice(name, brand);
		...
		if(rePrice > 0) { //1일경우
			System.out.printf("%s 브랜드의 %s 제품의 가격은 %s원입니다.", brand, name, rePrice);
		}else { //0
			System.out.print("해당 제품을 찾지 못했습니다.");
		}
